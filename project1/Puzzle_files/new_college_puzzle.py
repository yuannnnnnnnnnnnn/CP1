"""Puzzle file related to New College Dining Hall location"""
...
def display_puzzle1():
    ...
    chef_image = pygame.transform.scale(chef_image, (600, 600))
    ...
    while running:
        ...
        if message:
            ...
            screen.blit(message_surface, (screen_width // 2 - message_surface.get_width() // 2, screen_height - 150))
