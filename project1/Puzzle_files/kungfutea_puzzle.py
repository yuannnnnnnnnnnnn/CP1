"""Puzzle file related to KungFu Tea location"""
...
def display_puzzle2():
    """Displays the crossword puzzle in Pygame and handles user input."""
    ...
    chef_image = pygame.transform.scale(chef_image, (600, 300))
